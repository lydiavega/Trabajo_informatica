...
void Mundo::Inicializa()
{
	...
	gallina2.SetDims(47.2f, 42.3f);
	gallina2.SetPos(80.0f, 20.0f);
	gallina2.SetVel(0.0f, 0.0f);

	gallina3.SetDims(59.0f, 52.0f);
	gallina3.SetPos(60.0f, 20.0f);
	gallina3.SetVel(0.0f, 0.0f);

	cazador.SetDims(37.0f, 54.0f);
	cazador.SetPos(50.0f, 6.0f);
...
void Mundo::Mueve(void) {
	...
	gallina2.Mueve(0.025f);
	gallina3.Mueve(0.025f);
	cazador.Mueve(0.025f);
