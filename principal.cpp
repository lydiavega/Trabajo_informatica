...
void onDraw (void)
{
	//Inicialización del modo de dibujo
	glClear(GL_COLOR_BUFFER_BIT | GL_DEPTH_BUFFER_BIT);   // Limpia el color del buffer
	...
	//Establece el punto de vista y las coordenadas iniciales
